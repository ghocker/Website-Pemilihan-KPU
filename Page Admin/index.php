...
<body>
    ...
    <section class="text-center d-flex justify-content-center mt-4">
        <div class="card m-4" style="width: 60rem; margin-top: 500px;">
            ...
            <p class="lead mb-1">Selamat Datang di Portal Admin KPU IPDN SUMBAR</p>
            <p class="lead m-3;"></p>
            <div class="pb-5">
                <a href="hasil.php"><button class="btn btn-success" style="font-size: 16px;">LIHAT HASIL PEMUNGUTAN
                        SUARA</button></a>
