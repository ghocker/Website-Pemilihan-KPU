...
$data = query('SELECT * FROM sena GROUP BY nama ASC');
...
<body>
    ...
    <!-- akhir navbar -->
    <!-- awal jumbotron -->
    <h2 style="padding-top: 85px; text-align: center; font-size:34px;">PEMILIHAN SENAPATI</h2>
    <section class="text-center d-flex justify-content-center mt-4" style="padding-top: 30px;">
                ...
                <div class="thumbnail">
                    <div class="text-center">
                        ...
                        <div class="caption mt-3">
                            ...
                            <a href="detailsena.php?hak=<?= $row["npp"]; ?>" class="btn btn-success btn-block"
    ...
    function myFunction(key) {
        ...
        if (confirm("Apakah anda yakin dengan pilihan anda ?")) {
            location.href = "pilihsena.php?hak=" + key;
        } else {
