...
<body>
    ...
    <section class="text-center d-flex justify-content-center" style="padding-top: 100px;">
        <div class="col-md-3">
            <section class="wow fadeInDown" data-wow-delay="<?php echo $i; ?>s">
                <div class="thumbnail">
                    <div class="text-center">
                        <h1 class="text-black mb-4">PEMILIHAN SENAPATI</h1>
                        <img src="../assets/img/default.png" class="img">
                        <div class="caption mt-3">
                            <a href="sena.php" class="btn btn-warning btn-block" style="font-size: 16px;">PILIH</a>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <div class="col-md-3">
            <section class="wow fadeInDown" data-wow-delay="<?php echo $i; ?>s">
                <div class="thumbnail">
                    <div class="text-center">
                        <h1 class="text-black mb-4">PEMILIHAN WASENAPATI</h1>
                        <img src="../assets/img/default.png" class="img">
                        <div class="caption mt-3">
                            <a href="wasena.php" class="btn btn-warning btn-block" style="font-size: 16px;">PILIH</a>
                        </div>
                    </div>
                </div>
            </section>
